...
<head>
    ...
    <title>Leporello Kalender</title>
    <link href="leporello.css" rel="stylesheet" type="text/css">
</head>
<body>
<?php
...
<table width="100%" border="0" cellspacing="0" cellpadding="1">
    <tr>
        <td width="4%" valign="top" class="rvwt">&nbsp;</td>
        <td width="16%" valign="top" class="rvwt">
            <?php
            $monat = "7";
            $tag = "1";
        ...
        <td width="16%" valign="top" class="rhkw">
            <span class="rvwt">
                <?php
                $monat = "12";
                $tag = "1";
            ...
            <span class="front"><span class="copy">&copy; electronic-research.de</span></span>
        </td>
    </tr>
</table>
</body>
